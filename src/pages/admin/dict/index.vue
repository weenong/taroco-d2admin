...
export default {
  ...
  created () {
    this.getList()
    this.sys_dict_add = this.hasPermissions(['sys_dict_add'])
    this.sys_dict_upd = this.hasPermissions(['sys_dict_upd'])
    this.sys_dict_del = this.hasPermissions(['sys_dict_del'])
  },
  methods: {
    getList () {
