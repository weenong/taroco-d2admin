...
export default {
  ...
  created () {
    this.getList()
    this.menuManager_btn_add = this.hasFunctions(['sys_menu_add'])
    this.menuManager_btn_edit = this.hasFunctions(['sys_menu_edit'])
    this.menuManager_btn_del = this.hasFunctions(['sys_menu_del'])
  },
  computed: {
    ...mapGetters([
      'elements'
