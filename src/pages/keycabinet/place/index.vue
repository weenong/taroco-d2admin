<template>
  <d2-container>
    ...
    <template slot="header">
      <el-form :inline="true" :model="listQuery" size="mini" style="margin-bottom: -18px;">
        ...
        <el-form-item style="float: right">
          <el-button v-if="place_add" @click="handleCreate" type="primary" icon="el-icon-plus">新 增</el-button>
        </el-form-item>
      </el-form>
    </template>
    <!-- table表格 -->
    <el-table
      ...
      <el-table-column align="center" label="地址" :show-overflow-tooltip="true" width="120">
        <template slot-scope="scope">
          <span>{{scope.row.addr}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="备注" :show-overflow-tooltip="true" width="120">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          <el-button v-if="place_upd" size="mini" type="primary" @click="handleUpdate(scope.row)" icon="el-icon-edit"></el-button>
          <el-button v-if="place_del" size="mini" type="danger" @click="deletes(scope.row)" icon="el-icon-delete"></el-button>
        </template>
      </el-table-column>
...
<script>
import { fetchList, getObj, addObj, putObj, delObj } from '@/api/keycabinet/place'
...
export default {
  ...
  created () {
    this.getList()
    this.place_add = this.hasFunctions(['place_add'])
    this.place_upd = this.hasFunctions(['place_upd'])
    this.place_del = this.hasFunctions(['place_del'])
  },
  methods: {
    getList () {
