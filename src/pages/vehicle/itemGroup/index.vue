      ...
      <template slot="paneL">
        ...
        <div slot="header">
          <el-form :inline="true" :model="listQuery" size="mini" style="margin-bottom: -18px;">
            <el-form-item>
              <el-button v-if="itemGroup_add" @click="handleCreate" type="primary" icon="el-icon-plus">新 增</el-button>
            </el-form-item>
          </el-form>
        </div>
        <el-scrollbar style="height: 100%;"> <!-- 滚动条 -->
          ...
          <el-table
            ...
            <el-table-column align="center" label="编码" width="50px">
              <template slot-scope="scope">
                <span>{{scope.row.code}}</span>
              </template>
            </el-table-column>
            <el-table-column align="center" label="名称" width="50px">
              <template slot-scope="scope">
            ...
            <el-table-column align="center" label="操作" width="150px">
              <template slot-scope="scope">
                <el-button v-if="itemGroup_upd" size="mini" type="primary" @click="handleUpdate(scope.row)" icon="el-icon-edit"></el-button>
                <el-button v-if="itemGroup_del" size="mini" type="danger" @click="deletes(scope.row)" icon="el-icon-delete"></el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-scrollbar>
...
<script>
import { fetchList, getObj, addObj, putObj, delObj } from '@/api/vehicle/itemGroup'
...
export default {
  ...
  created () {
    this.getList()
    this.itemGroup_add = this.hasFunctions(['itemGroup_add'])
    this.itemGroup_upd = this.hasFunctions(['itemGroup_upd'])
    this.itemGroup_del = this.hasFunctions(['itemGroup_del'])
  },
  methods: {
    getList () {
